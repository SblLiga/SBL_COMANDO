    ...
    return _with_dates(
        {
            ...
            "pending_demotion": bool(getattr(user, "pending_demotion", False)),
    ...
    return _with_dates(
        {
            ...
            "next_month_zone": getattr(member, "next_month_zone", None),
            "next_month_tasks": getattr(member, "next_month_tasks", None) or [],
            "next_month_reward": getattr(member, "next_month_reward", None),
            "next_month_reward_image": getattr(member, "next_month_reward_image", None),
